...
class NotificationEventHandler
{
    ...
    public function onNewUserSignup($data)
    {
        ...
        $this->doNotificationActions($notifications, [
    ...
    public function onDocCommented($data)
    {
        ...
        $this->doNotificationActions($notifications, [
            'data'                       => ['comment' => $data->toArray(), 'doc' => $doc->toArray()],
    ...
    public function onDocAnnotated($data)
    {
        ...
        $this->doNotificationActions($notifications, [
            'data'                                => ['annotation' => $data->toArray(), 'doc' => $doc->toArray()],
    ...
    public function onDocSubcomment($subcomment, $activity)
    {
        ...
        if (isset($notice)) {
            ...
            $this->doNotificationActions($notification, [
                'data'                       => ["subcomment" => $subcomment->toArray(), "activity" => $activity->toArray()],
    ...
    public function onNewActivityVote($vote_type, $activity, $user)
    {
        ...
        if (isset($notice)) {
            ...
            $this->doNotificationActions($notification, [
                'data'                       => ['intro' => $intro, 'vote_type' => $vote_type, 'activity' => $activity->toArray(), 'user' => $user->toArray()],
    ...
    public function onNewGroupDocument($doc, $group)
    {
        ...
        if (isset($notices)) {
            ...
            $this->doNotificationActions($notifications, [
                'data'                                => ['user_id' => Auth::user()->id, 'doc' => $doc->toArray(), 'group' => $group->toArray()],
