...
//Api Routes
    ...
    Route::post('api/docs/{doc}/comments/{comment}/hide', 'CommentApiController@destroy');
    Route::delete('api/docs/{doc}/comments/{comment}/delete', 'CommentApiController@destroy');
