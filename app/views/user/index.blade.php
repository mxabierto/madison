							...
							<ul class="user-sponsored-docs" ng-show="showVerified()">
								<li class="user-sponsored-doc" ng-repeat="doc in docs">
									...
									<div class="list-doc-info">
										<span class="doc-created-date">{{ 'POSTED' | translate }} @{{ doc.created_at | parseDate | date:'mediumDate' }}</span>
										<span class="doc-updated-date">{{ 'UPDATED' | translate }} @{{ doc.created_at | parseDate | date:'mediumDate' }}</span>
									</div>
								</li>
							</ul>
						</tab>
